export const contentTypes: {[key: string]: Array<string>;} = {
    '3dm': ['x-world/x-3dmf'],
    '3dmf': ['x-world/x-3dmf'],
    ...
    'rgb': ['image/x-rgb'],
    'rm': ['application/vndrn-realmedia', 'audio/x-pn-realaudio'],
    'rmi': ['audio/mid'],
    ...
    'sh': ['application/x-bsh', 'application/x-sh', 'application/x-shar', 'text/x-scriptsh'],
    ...
    'stl': ['application/sla', 'application/vndms-pkistl', 'application/x-navistyle'],
    ...
    'viv': ['video/vivo', 'video/vndvivo'],
    'vivo': ['video/vivo', 'video/vndvivo'],
    ...
    'xlc': ['application/excel', 'application/vndms-excel', 'application/x-excel'],
    'xld': ['application/excel', 'application/x-excel'],
    'xlk': ['application/excel', 'application/x-excel'],
    'xll': ['application/excel', 'application/vndms-excel', 'application/x-excel'],
    'xlm': ['application/excel', 'application/vndms-excel', 'application/x-excel'],
    ...
    'xlw': ['application/excel', 'application/vndms-excel', 'application/x-excel', 'application/x-msexcel'],
    'xm': ['audio/xm'],
