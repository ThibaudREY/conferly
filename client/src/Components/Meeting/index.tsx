...
import { FaPaintBrush, FaGithub } from 'react-icons/fa';
    ...
    render() {
        ...
        return (
            <div className="container-fluid">
                ...
                <div className={`row fixed-bottom ${!items[1].show ? 'retracted' : ''}`} onClick={(e: React.MouseEvent) => !items[1].show ? this.toggleItemAt(1) : {}}>
                    <div className="col-8">
                        <Chat />
                    </div>
